...
import creditcard from '../../../img/icons/creditcardfooter.png'
    ...
    return (
        <div className="infopage_container">
            <div className="infopage_about">
                ...
                <div className='infopage_secondary-text'>
                    Магазин одежды <b>Feature</b> - это новое слово в мире моды и стиля. Он был открыт в 2023 году и с тех пор завоевал авторитет у любителей современной одежды в sketch-стиле.

                    <p/>В Feature вы найдете уникальные вещи, которые созданы с огромным вниманием к деталям и дизайну. Каждый предмет одежды выглядит необычно и отличается особой индивидуальностью, что делает его поистине уникальным.

                    <p/>Команда дизайнеров магазина <b>Feature</b> работает над созданием вещей, которые не просто соответствуют современным трендам моды, но и отличаются своей уникальностью и качеством.

                    <p/>Один из ключевых элементов при выборе одежды в <b>Feature</b> - это индивидуальность покупателей. Магазин предлагает людям выражать свою собственность через одежду, позволяя каждому найти что-то идеально подходящее для себя.

                    <p/>Таким образом, если вы хотите создать свой собственный, неповторимый стиль, то <b>Feature</b> - это именно то место, куда стоит заглянуть. Одежда в скетч стиле подойдет любому человеку, который желает выразить свою индивидуальность и не бояться выделяться из общей массы.</div>
                <div className='cart_line'></div>
            </div>
            <div className="infopage_delivery">
                <div className="infopage_title"><img className='infopage_icon' src={cross} alt='cross'></img> Доставка и оплата</div>
                <div className="infopage_text">
                    <div className='infopage_block'>
                        <div className='infopage_secondary-title'><img className='infopage_icon' alt='img' src={money}></img> Наличными</div>
                        <div className='infopage_secondary-text'>Оплата заказа наличными курьеру. Действует только на территории Москвы (внутри МКАД)</div>
                    </div>
                    <div className='infopage_block'>
                        <div className='infopage_secondary-title'><img className='infopage_icon' alt='img' src={creditcard}></img> Банковскими картами</div>
                        <div className='infopage_secondary-text'>Безопасная оплата заказа на сайте банковскими картами по протоколу 3D Secure</div>
                    </div>
                </div>
                    <div className='infopage_text'>
                        <div className='infopage_block'>
                            <div className='infopage_secondary-text'>
                            <div className='infopage_secondary-title'><img className='infopage_icon' alt='img' src={box}></img> Самовывоз</div>
                                Самовывоз осуществляется из нашего магазина. Заказ резервируется на 2 дня
                            </div>
                        </div>
                        <div className='infopage_block'>
                            <div className='infopage_secondary-text'>
                            <div className='infopage_secondary-title'><img className='infopage_icon' alt='img' src={delivery}></img> Курьером</div>
                                Доставка в пределах МКАД осуществляется в течение 1-2 рабочих дней. Доставка бесплатная.
                            </div>
                        </div>
                    </div>
                <div className='cart_line'></div>
            </div>
            <div className="infopage_refund">
                <div className="infopage_title"><img className='infopage_icon' src={cross} alt='cross'></img> Возврат</div>
                <div className="infopage_secondary-text">
                Мы стремимся обеспечить наших клиентов качественными и удобными товаром. Если по какой-то причине вы не удовлетворены своей покупкой, вы можете вернуть товар в течение 14 дней с момента получения посылки.

                <p/>Условия возврата:
                <p/>- товар должен быть в идеальном состоянии, с оригинальными этикетками и упаковкой;
                <p/>- сохранены все документы и чек;
                <p/>- обувь не должна иметь следов носки;

                <p/>Процесс возврата:
                <p/>1. Свяжитесь с нами по электронной почте или телефону, чтобы сообщить о вашем желании вернуть товар.
                <p/>2. Подготовьте товар к возврату и упакуйте его в надежную коробку.
                <p/>3. Отправьте посылку обратно по указанному адресу.
                <p/>4. После получения товара нашими специалистами мы свяжемся с вами и вернем стоимость покупки на вашу банковскую карту.

                <p/>Стоимость доставки при возврате возмещается покупателем.

                <p/>Благодарим вас за покупку и надеемся на дальнейшее сотрудничество!
                </div>
                <div className='cart_line'></div>
            </div>
            <div className="infopage_contacts">
                <div className="infopage_title"><img className='infopage_icon' src={cross} alt='cross'></img> Контакты</div>
                <div className="infopage_text">
                     <div className='infopage_wrapper'>
                        <div className="infopage_secondary-title"><img className='infopage_icon' alt='img' src={telephone}></img> Телефон</div>
                        <div className="infopage_secondary-text">8 (906) 066 15 55</div>
                     </div>
                     <div className='infopage_wrapper'>
                        <div className="infopage_secondary-title"><img className='infopage_icon' alt='img' src={mail}></img> Почта</div>
                        <div className="infopage_secondary-text">feature@google.com</div>
                     </div>
                     <div className='infopage_wrapper'>
                        <div className="infopage_secondary-title"><img className='infopage_icon' alt='img' src={location}></img> Наш адрес</div>
                        <div className="infopage_secondary-text">г. Москва, ул. Иванова, д.7</div>
                     </div>
                     <div className='infopage_wrapper'>
                        <div className="infopage_secondary-title"><img className='infopage_icon' alt='img' src={file}></img> Реквизиты</div>
                        <div className="infopage_secondary-text"> ИП Кузьмин Владимир Алексеевич
                                                                <p/> ИНН: 775109017478
                                                                <p/>ОГРНИП: 314774624700988
                                                                <p/>Банк: ТОЧКА ПАО БАНКА "ФК ОТКРЫТИЕ"
                                                                <p/>БИК: 044525999
                                                                <p/>Расчётный счет: 40802810401500049108
            ...
            <div className="infopage_politics">
                <div className="infopage_title"><img className='infopage_icon' src={cross} alt='cross'></img> Политика конфиденциальности</div>
                <div className="infopage_secondary-text">
                <p/> Политика в отношении обработки персональных данных
                <p/> 1. Общие положения
                <p/> Настоящая политика обработки персональных данных составлена в соответствии с требованиями Федерального закона от 27.07.2006. № 152-ФЗ «О персональных данных» (далее — Закон о персональных данных) и определяет порядок обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Илюхиным Денисом Юрьевичем (далее — Оператор).
                ...
                <p/> 1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://feature.com.
                ...
                <p/> 2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://feature.com.
                ...
                <p/> 2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://feature.com.
                <p/> 2.9. Персональные данные, разрешенные субъектом персональных данных для распространения, — персональные данные, доступ неограниченного круга лиц к которым предоставлен субъектом персональных данных путем дачи согласия на обработку персональных данных, разрешенных субъектом персональных данных для распространения в порядке, предусмотренном Законом о персональных данных (далее — персональные данные, разрешенные для распространения).
                <p/> 2.10. Пользователь — любой посетитель веб-сайта https://feature.com.
                ...
                <p/> 3. Основные права и обязанности Оператора
                ...
                <p/> 4. Основные права и обязанности субъектов персональных данных
                ...
                <p/> 6. Цели обработки персональных данных
                ...
                <p/> электронный адрес;
                <p/> номера телефонов;
                <p/> адрес фактического места проживания и регистрации по месту жительства и/или по месту пребывания;
                <p/> Правовые основания:
                <p/> договоры, заключаемые между оператором и субъектом персональных данных;
                <p/> Виды обработки персональных данных:
                <p/> Сбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание персональных данных;
                <p/> Отправка информационных писем на адрес электронной почты
                ...
                <p/> 8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора feature@google.com с пометкой «Актуализация персональных данных».
                ...
                <p/> Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора feature@google.com с пометкой «Отзыв согласия на обработку персональных данных».
                ...
                <p/> 9. Перечень действий, производимых Оператором с полученными персональными данными
                ...
                <p/> 10. Трансграничная передача персональных данных
                ...
                <p/> 11. Конфиденциальность персональных данных
                ...
                <p/> 12. Заключительные положения
                <p/> 12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты feature@google.com.
                ...
                <p/> 12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://feature.com/about.
                </div>
                <div className='cart_line'></div>
            </div>
